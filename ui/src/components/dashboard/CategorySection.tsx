  ...
  return (
    <section className="rounded-lg border border-gray-200 bg-white p-6">
      ...
      <form className="mt-4 flex flex-col gap-3" onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className="cursor-pointer rounded-md bg-brand px-4 py-2 text-sm font-semibold text-white"
        >
          Adicionar
        </button>
      </form>
              ...
              <div key={category.id} className="flex flex-col gap-2">
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex flex-1 cursor-pointer items-center justify-between rounded-md border border-gray-100 px-3 py-2 text-left text-sm text-gray-800 transition hover:bg-gray-50"
                  >
                  ...
                  <button
                    ...
                    className="cursor-pointer rounded-md border border-red-200 px-3 py-2 text-xs font-semibold text-red-600 transition hover:bg-red-50"
                  >
                    Excluir
                  </button>
                </div>
